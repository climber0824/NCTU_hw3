...
def enforce_size(img, targets, masks, num_crowds, new_w, new_h):
    """ Ensures that the image is the given size
...
def detection_collate(batch):
    """Custom collate fn for dealing with batches of images that
...
if __name__ == "__main__":
    dataset = Detection(
        image_path=cfg.dataset.train_images, info_file=cfg.dataset.train_info
    )
